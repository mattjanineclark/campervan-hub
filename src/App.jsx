...
/* Row 2: Book button */}
          <div style={{display:"flex",justifyContent:"flex-end",paddingBottom:8,paddingTop:2}}>
            <button onClick={()=>setShowBook(true)} style={{...btn(T.primary,T.surface,{fontWeight:700})}}>+ Book</button>
          </div> React, { useState, useReducer, useRef, useEffect, useCallback } from "react";
        ...
        {tab==="calendar"&&(
          <>
            ...
            <div style={card({padding:14})}>
              <CollapsibleStats bookings={state.bookings} families={families}/>
            </div>
          </>
        )}
